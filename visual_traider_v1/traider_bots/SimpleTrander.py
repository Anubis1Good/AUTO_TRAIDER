...
class SimpleTraider(VisualTraider):
    def __init__(self, glass_region: tuple, chart_region: tuple) -> None:
        ...
        self.buff = (self.region_chart[3]-self.region_chart[1])//15
    ...
    def run(self, img):
        ...
        chart = img[self.region_chart[1]:self.region_chart[3],self.region_chart[0]:int(self.region_chart[2]*0.9)]
        try:
            ...
            cv2.line(img,
                     ...
                     (int(self.region_chart[2]*0.9),self.region_chart[3]),
                     (150,150,140),
                     5)
